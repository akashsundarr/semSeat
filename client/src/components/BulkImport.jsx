...
function BulkImport({ onImport, onComplete }) {
  ...
  return (
    <div className="p-4 border-t">
      <h3 className="text-lg font-semibold mb-2 text-gray-800">Bulk Import from CSV</h3>
      <div className="text-xs text-gray-600 mb-4 p-2 bg-gray-100 rounded-md">
      ...
      <button
        ...
        className="w-full mt-4 px-4 py-2 bg-green-700 text-white rounded-md font-semibold hover:bg-green-800 disabled:bg-gray-400 transition"
      >
